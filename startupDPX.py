...
def main():
    ...
    dpx = Dosepix('/dev/ttyUSB1 ', 2e6, 'Configurations/DPXConfig_22.conf')
    ...
    # dpx.thresholdEqualizationConfig('Configurations/DPXConfig_6.conf', I_pixeldac=None, reps=1, intPlot=False, resPlot=True)
...
class Dosepix:
    ...
    def __init__(self, portName, baudRate, configFn):
        ...
        assert os.path.isfile(THL_CALIB_FILE), 'Need the specified THL Calibration file %s!' % THL_CALIB_FILE
